...
| Title                                       | Conference / Journal | Paper                                     | Code                                        | Remarks   |
| ------------------------------------------- | ---------- | ----------------------------------------- | ------------------------------------------- |-----------|
| Cultural Moment Benchmark: Evaluating Video Cultural Reasoning and Grounding in Southeast Asia | EMNLP Main 2026 | [2608.23065](https://arxiv.org/abs/2608.23065) | [Dataset](https://huggingface.co/datasets/Multimedia-SMU/culturalmoment-benchmark), [Project Page](https://culturalmoment-benchmark.github.io/) | Data, Video VLM Evaluation, Temporal Grounding, Southeast Asia |
| Seeing Culture: A Benchmark for Visual Reasoning and Grounding | EMNLP Main 2025 | [2509.16517](https://arxiv.org/abs/2509.16517) | [Dataset](https://huggingface.co/datasets/Multimedia-SMU/seeingculture-benchmark), [Code](https://github.com/buraksatar/SeeingCulture), [Project Page](https://seeingculture-benchmark.github.io/) | Data, VLM Evaluation, Visual Grounding, Southeast Asia |
